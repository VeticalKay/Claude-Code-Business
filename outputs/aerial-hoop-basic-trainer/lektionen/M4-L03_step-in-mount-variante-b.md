# Modul 4 — Lektion 4.3: Step in Mount — Variante B

> **Vorlagen-Lektion** — folgt demselben Format wie Variante A.
...
### Step in Mount — Variante B: (Videolink)
*(Level 1)*

Variante B ist die Variante für den **höher hängenden Hoop**. Hier können wir nicht mehr direkt mittig hinter den Hoop treten und das Spielbein einfach in den Hoop heben – wir kommen aus der Seite, drehen den Hoop zu uns und steigen elegant durch ihn hindurch. Es ist die Variante, die uns auch bei normaler Hoop-Höhe Zugang gibt.
...
🎥 **Demo-Video:** *(Embed Step in Mount Variante B)*
*Datei: `M4-L03_Step-in-Mount-Variante-B.mp4` — Drive-Ordner: "Step in Mount"*
...
- *„Seitlich neben den Hoop – aufrecht."*
...
- Direkt aus Variante B in den Basic Seat (Modul 5.1)
- Weiter in komplexere Mounts (Side Mount, Single Leg Mount)
- Im Spinning-Modus
...
**1. Wo stehen wir in der Ausgangspose von Variante B?**
- a) mittig hinter dem Hoop
- b) ✅ aufrecht und seitlich neben dem Hoop
- c) vor dem Hoop
- d) mittig im Hoop

**2. Wo greifen unsere Hände den Hoop in der Ausgangspose?**
- a) bei 9 und 15 Uhr
- b) ✅ zwischen 6:00 und 9:00 Uhr oder zwischen 6:00 und 15:00 Uhr
- c) ganz oben an der Aufhängung
- d) bei 12 Uhr und 6 Uhr

**3. Wie greift die vordere Hand zur hinteren Hand?**
- a) ✅ die vordere Hand greift unter die hintere Hand, die Handflächen-Innenseiten zeigen zueinander
- b) die Hände greifen übereinander
- c) die Hände greifen nebeneinander auf einer Höhe
- d) die Handrücken zeigen zueinander

**4. Welches Bein wird unser Standbein?**
- a) ✅ das vordere, publikumsnahe Bein (da, wo die Hand etwas tiefer greift)
- b) das hintere, publikumsferne Bein
- c) egal, beide Beine arbeiten gleich
- d) das aktive Bein

**5. Wo greifen wir am Ende mit beiden Händen?**
*(Freitext – wir denken nach)*

> Erwartete Antwort: Wir greifen mit beiden Händen ganz oben an die Bar, seitlich neben der Aufhängung von 12:00 Uhr.

---

## Download

📎 **Cueing-Karte Step in Mount Variante B** *(A6, doppelseitig, zum Ausdrucken)*
*Datei: `M4-L03_cueing-karte_step-in-mount-variante-b.pdf` – in Canva erstellt, Brand-Farben Magenta / Nude / Schwarz.*
