# To-Do Liste — Katarina

> Diese Datei wird täglich von der automatischen Routine gelesen.
> Bitte Aufgaben selbst eintragen oder in der Session mit Claude ergänzen.
...
- [ ] Feedback-Formular in Canva nachbauen (schönere Alternative zu Google Forms)
...
- [x] **Coach-Vorgaben dokumentiert** — English-First, Instructor Training-Fokus, Business-Page-Trennung (Personal-Seite existiert schon) (13.05.2026)
- [x] **Content-Brand-Mapping etabliert** — Studio Brand für Founder/Studio-Content, Education Brand für Ausbildungs-Content (13.05.2026)
...
- [x] 12 gebuchte Zukunftstermine (Mai–Oktober 2026) rekonstruiert (25.04.2026)
- [x] 8 Heimtrainings-PDFs erstellt (Dark Luxury Design) (25.04.2026)
