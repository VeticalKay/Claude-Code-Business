...
PLANS = [
    dict(num=1, name='Klassisch', subtitle='Grundlage · alle Levels',
         exercises=[
             ('Handgelenk & Sehnen',  [E['hgk1']]),
             ('Schulter',             [E['sside']]),
             ('Brust & Mobilisation', [E['brust']]),
             ('Core & Bauch',         [E['dbug'], E['hueft']]),
             ('Push Ups',             [E['pu_beg']]),
         ]),
    dict(num=2, name='Tiefenstabilität', subtitle='Plank-Focus · alle Levels',
         exercises=[
             ('Handgelenk & Sehnen', [E['hgk2']]),
             ('Schulter & Core',     [E['splank']]),
             ('Brust',               [E['brust_pl']]),
             ('Core & Bauch',        [E['cdyn'], E['sdips']]),
             ('Push Ups',            [E['pu_beg']]),
         ]),
    dict(num=3, name='Mobilität & Kraft', subtitle='Oberkörper-Focus · alle Levels',
         exercises=[
             ('Handgelenk & Sehnen', [E['hgk3']]),
             ('Schulter',            [E['scar']]),
             ('Schulter & Brust',    [E['dolph']]),
             ('Core & Bauch',        [E['core2']]),
             ('Push Ups',            [E['pu3']]),
         ]),
    dict(num=4, name='Lateralstärke', subtitle='Seitliche Muskulatur · alle Levels',
         exercises=[
             ('Handgelenk & Sehnen', [E['hgk1']]),
             ('Schulter & Brust',    [E['wand']]),
             ('Core & Bauch',        [E['core3'], E['sdips']]),
             ('Hüftbeuger',          [E['hueft']]),
             ('Push Ups',            [E['pu_beg']]),
         ]),
    ...
    dict(num=6, name='Core Intensiv', subtitle='Bauch-Schwerpunkt · alle Levels',
         exercises=[
             ('Handgelenk & Sehnen', [E['hgk3']]),
             ('Schulter',            [E['sside']]),
             ('Core & Bauch',        [E['core5'], E['cdyn'], E['dbug']]),
             ('Push Ups',            [E['pu_beg']]),
         ]),
